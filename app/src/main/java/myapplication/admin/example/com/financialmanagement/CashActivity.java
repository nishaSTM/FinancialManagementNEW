...
public class CashActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter =  new ViewPagerAdapter(getSupportFragmentManager(),Titles,Numboftabs,db_dates);
       ...
       CashListFragment info = new CashListFragment();
...
class ViewPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public ViewPagerAdapter(FragmentManager fm,CharSequence mTitles[], int mNumbOfTabsumb, ArrayList<User> db_dates) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        ...
        else             // As we are having 2 tabs if the position is now 0 it must be 1 so we are returning second tab
        {
            Bundle bundle = new Bundle();
            bundle.putSerializable("key",db_dates);
            CashReportFragment cashReportFragment = new CashReportFragment();
            cashReportFragment.setArguments(bundle);
            return cashReportFragment;
        }
